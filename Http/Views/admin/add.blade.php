@extends('Core.Admin.Http.Views.layout', [
    'title' => __('admin.title', ['name' => __('carousel.add')]),
])
...
@push('content')
    ...
    <form data-carouselform="add" data-page="carousel" enctype="multipart/form-data">
        @csrf
        ...
        <div class="position-relative row form-group">
            ...
            <div class="col-sm-9">
                <input name="link" id="link" placeholder="@t('carousel.link')" type="text" class="form-control">
            </div>
        </div>
